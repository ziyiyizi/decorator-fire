...
const fastShellBlacklist = ['Falling Leaves', 'Floral'];
...
function seqTwoRandom() {
	...
	shell1.wordPos = wordPos++;
	shell2.wordPos = wordPos++;
...
const Star = {
	...
	add(x, y, color, angle, speed, life, speedOffX, speedOffY) {
		...
		instance.startX = x;
		instance.startY = y;
		instance.isSpart = false;
		instance.wordPos = undefined;
...
if (IS_HEADER) {
	...
	setLoadingStatus('Fireworks Together!');
	setTimeout(() => {
